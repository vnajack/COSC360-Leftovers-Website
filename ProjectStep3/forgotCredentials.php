     ...
     <main id="forgottenCredentials">
       ...
       <form name="getCredentials" method=post  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" autocomplete="off">
         <fieldset>
           ...
           <p class="important-notice">An asterisk (*) indicates a required field.</p>
           <table class="tableFieldset">
             <tr>
               <th><label>What is the email address associated with your account?</label><span class="important-notice">*</span><?php echo "<span class=\"leftBlank\">".$emailError."</span>";?></th>
               <td><input autofocus required type="email" name="email" value = "<?php echo $email;?>"></td>
             </tr>
             <tr>
               <th><label> Which credential(s) did you forget?<span class="important-notice">*</span><?php echo "<span class=\"leftBlank\">".$credentialError."</span>";?></label></th>
             ...
             <tr>
               <th><label>What is your security question?<span class="important-notice">*</span></label></th>
     					<td><?php echo "<span class=\"leftBlank\">".$securityQuestionError."</span>";?><select name="securityQuestion" id="secQuestion" title="This is used to reset your password if you forget it">
             ...
             <tr>
               <th><label>Provide the answer to your security question:</label><span class="important-notice">*</span></th>
               <td><?php echo "<span class=\"leftBlank\">".$securityResponseError."</span>";?><input type="text" name="securityResponse" required value = "<?php echo $securityResponse;?>"></td>
             </tr>
           </table>
         </fieldset>
         <input type = "submit">
