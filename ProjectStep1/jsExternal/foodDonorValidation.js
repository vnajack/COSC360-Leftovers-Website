...
function checkDonor(){
  ...
  var createTextbox = document.getElementById("createTextbox"); //the div in foodDonorForm.html
	...
	if (inputedDonor == "onCampusEvent"){ //if the user chose "On-campus Event"
		...
		createTextbox.innerHTML = createTextbox.innerHTML + "<p>Email our executives to become a trusted donor! <a href='mailto:leftoversubco@gmail.com?Subject=New%20Food%20Provider'><img src='images/email_16.png'></a></p>"
	}
}
